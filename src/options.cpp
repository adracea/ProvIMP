...
*/
    ...
    ui->mapEdit->setText(settings.value("mapPath", "https://evemaps.dotlan.net/svg/").toString());
    ui->bridgeEdit->setText(settings.value("bridgePath", "https://eternaldusk.com/imp/jb/").toString());
